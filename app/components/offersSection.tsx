  ...
  return (
    <section className="py-18">
      ...
      <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
        <Reveal>
          <>
            <div className="rounded-xl border border-[--border-color] bg-[var(--card-bg)] p-6 text-center backdrop-blur transition hover:scale-[1.03] hover:cursor-pointer hover:bg-[var(--text-slate-hover)]">
