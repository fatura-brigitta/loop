          ...
          <>
            <div className="grid gap-6 md:grid-cols-5">
              {ranks.map((r) => {
                ...
                return (
                  <div
                    className="rounded-xl border border-[--border-color] bg-[--card-bg] p-6 text-center backdrop-blur transition hover:scale-[1.05] hover:bg-slate-100 dark:hover:bg-white/10"
                    key={r.id}
                  >
